...
public class MerchantRegisterActivity extends AppCompatActivity {
    ...
    private EditText full_name_et, merchant_name_et, phone_number_et, delivery_fee_et, address_et,
            email_et, password_et, confirm_password_et;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        my_location_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (IsConnectedToInternet.isConnectedToInternet(MerchantRegisterActivity.this)) {
                    //check is location service enabled
                    if (IsLocationServiceEnabled.isLocationServiceEnabled(MerchantRegisterActivity.this)) {
                        //get or select current location
                        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(MerchantRegisterActivity.this);
                        getLocation();
                    } else {
        ...
        merchant_image_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //pick image
                showImagePickDialog();
    ...
    private void getLocation() {
        if (ContextCompat.checkSelfPermission(MerchantRegisterActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission(MerchantRegisterActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        Intent intent = new PlacePicker.IntentBuilder()
                                ...
                                .build(MerchantRegisterActivity.this);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (i == 0) {
                            ...
                            if (ContextCompat.checkSelfPermission(MerchantRegisterActivity.this,Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED &&
                                    ContextCompat.checkSelfPermission(MerchantRegisterActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                            ...
                            //gallery clicked
                            if (ContextCompat.checkSelfPermission(MerchantRegisterActivity.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                                //if camera permission allowed, can pick image from camera
                                pickFromGallery();
                            } else {
                                //if camera permission not allowed, request permission
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == Constants.PLACE_PICKER_REQUEST) {
                ...
                Geocoder geocoder = new Geocoder(MerchantRegisterActivity.this, Locale.getDefault());
                try {
                    List<Address> addresses = geocoder.getFromLocation(addressData.getLatitude(), addressData.getLongitude(), 1);
                    merchantCity = addresses.get(0).getLocality();
                    address_et.setText(addresses.get(0).getAddressLine(0));
                } catch (Exception e) {
                    TastyToast.makeText(MerchantRegisterActivity.this, e.getMessage(), TastyToast.LENGTH_SHORT, TastyToast.ERROR).show();
                }
            }
    ...
    String fullName, merchantName, phoneNo, deliveryFee, merchantAddress, email, password, confirmPassword;
    ...
    private void validateData() {
        ...
        merchantAddress = address_et.getText().toString().trim();
        ...
        if (Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
            if (password.length() >= 8) {
                if (password.equals(confirmPassword)) {
                    ...
                    confirm_password_et.setError("Password doesn't match!", errorIcon);
                }
            } else {
                password_et.setError("Password must be contains at least 8 characters!", errorIcon);
            }
        } else {
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        TastyToast.makeText(MerchantRegisterActivity.this, e.getMessage(), TastyToast.LENGTH_LONG, TastyToast.ERROR).show();
                    }
                });
    }
    ...
    private void saveFirebaseData() {
        ...
        if (imageUri == null) {
            ...
            hashMap.put("merchantCity", "" + merchantCity);
            hashMap.put("accountType", "Merchant");
            ...
            databaseReference.child(firebaseAuth.getUid()).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismiss();
                            //db updated
                            startActivity(new Intent(MerchantRegisterActivity.this, MainMerchantActivity.class));
                            finish();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
